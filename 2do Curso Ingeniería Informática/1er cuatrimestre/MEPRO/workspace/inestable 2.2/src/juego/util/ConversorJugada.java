...
public class ConversorJugada {
	...
	public static Celda convertir(String textoJugada, Tablero tablero) throws CoordenadasIncorrectasException {
		...
		if (validar(textoJugada, tablero)) {
			...
			throw new CoordenadasIncorrectasException(
					"No se puede convertir " + textoJugada + " en coordenadas válidas dentro del tablero");
		}
	 ...
	 */
	private static char calcularSuperior(char letra, int tamano) {
		return (char) (letra + tamano - 1); // limite superior
	}
